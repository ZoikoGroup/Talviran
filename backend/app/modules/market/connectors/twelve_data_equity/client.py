...
per-symbol trading data. Verified live (2026-09-18): Twelve Data's public
"demo" key exists but only serves a small fixed whitelist of US large-cap
symbols (e.g. AAPL) — every other symbol, including any NSE-listed one,
gets refused with the same generic 401, so the demo key cannot stand in
for a real key here.
...
endpoint, e.g. Tata Motors resolves to symbol="TATAMOTORS",
exchange="NSE", not "TATAMOTORS.NSE".
"""
